...
describe("model display helpers", () => {
  ...
  test("buildModelDisplayName prefixes NG-/OR-", () => {
    expect(buildModelDisplayName("naga", "anthropic/claude-3-opus")).toBe("NG-anthropic/claude-3-opus");
    expect(buildModelDisplayName("openrouter", "openai/gpt-4o")).toBe("OR-openai/gpt-4o");
  });
